...
//
//     final myInventrySearchResponse = myInventrySearchResponseFromJson(jsonString);

import 'dart:convert';

MyInventrySearchResponse myInventrySearchResponseFromJson(String str) =>
    MyInventrySearchResponse.fromJson(json.decode(str));

String myInventrySearchResponseToJson(MyInventrySearchResponse data) =>
    json.encode(data.toJson());

class MyInventrySearchResponse {
  String message;
  bool status;
  int statusCode;
  List<MyInventrySearchDatum> data;

  MyInventrySearchResponse({
  ...
  factory MyInventrySearchResponse.fromJson(Map<String, dynamic> json) =>
      MyInventrySearchResponse(
        message: _asString(json["message"]),
        status: _asBool(json["status"]),
        statusCode: _asInt(json["status_code"]),
        data: _extractInventorySearchItems(
          json["data"],
        ).map((x) => MyInventrySearchDatum.fromJson(_asMap(x))).toList(),
      );
...
class FuelType {
  ...
  FuelType({required this.id, required this.name, required this.colourCode});

  factory FuelType.fromJson(Map<String, dynamic> json) => FuelType(
    id: _asInt(json["id"]),
    name: _asString(json["name"]),
    colourCode: _asString(json["colour_code"] ?? json["color_code"]),
  );
...
List<dynamic> _extractInventorySearchItems(dynamic value) {
