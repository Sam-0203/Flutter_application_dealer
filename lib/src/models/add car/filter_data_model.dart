...
//
//     final filterDataListResponse = filterDataListResponseFromJson(jsonString);

import 'dart:convert';

FilterDataListResponse filterDataListResponseFromJson(String str) =>
    FilterDataListResponse.fromJson(json.decode(str));

String filterDataListResponseToJson(FilterDataListResponse data) =>
    json.encode(data.toJson());

class FilterDataListResponse {
  String message;
  bool status;
  int statusCode;
  List<CarFilterDatumList> data;

  FilterDataListResponse({
  ...
  factory FilterDataListResponse.fromJson(Map<String, dynamic> json) =>
      FilterDataListResponse(
        message: _asString(json["message"]),
        status: _asBool(json["status"]),
        statusCode: _asInt(json["status_code"]),
        data: _extractFilterItems(
          json["data"],
        ).map((x) => CarFilterDatumList.fromJson(_asMap(x))).toList(),
      );
...
class CarFilterDatumList {
  ...
  factory CarFilterDatumList.fromJson(Map<String, dynamic> json) =>
      CarFilterDatumList(
        id: _asInt(json["id"]),
...
List<dynamic> _extractFilterItems(dynamic value) {
